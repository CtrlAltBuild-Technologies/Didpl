            ...
            <Container className="relative z-20 text-white w-full">
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <a href="https://wa.me/918866909600?text=Hi%2C%20I%20am%20interested%20in%20Dholera%20Homes%203.%20I%20would%20like%20to%20book%20a%20free%20site%20visit.%20Please%20share%20the%20details." target="_blank" rel="noopener noreferrer">
                ...
                <div className="flex flex-col md:flex-row gap-16 items-center">
                    <div className="md:w-1/2">
                        <div className="aspect-square relative rounded-[2rem] overflow-hidden border-4 border-[#D4AF37]/30 shadow-2xl">
                            <Image
                                src="/projects/homes3-location.png"
                                alt="Dholera Homes 3 Location Map"
                                fill
                                className="object-cover"
                            />
                        </div>
