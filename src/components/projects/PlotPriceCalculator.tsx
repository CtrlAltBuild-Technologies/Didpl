        ...
        <>
            ...
            <style jsx global>{`
                @media print {
                    ...
                    /* Hide everything structurally by setting visibility hidden */
                    body * {
                        visibility: hidden !important;
                    }

                    /* Only show the calculation form and its descendant contents */
                    #proposal-printable-${projectId}, 
                    #proposal-printable-${projectId} * {
                        visibility: visible !important;
                    }

                    /* Position the form perfectly and force it to be the only thing on the page */
                    #proposal-printable-${projectId} {
                        ...
                        width: 100% !important;
                        margin: 0 !important;
                        padding: 0 !important; /* using page margin instead */
                    ...
                    /* Ensure normal scroll height isn't translated to print blank pages */
                    html, body {
                    ...
                    /* Hide interactive buttons during printing completely */
                    .no-print, .no-print * {
                        display: none !important;
                        height: 0 !important;
                    }

                    /* Optimization for standard table layouts in prints */
                    table {
                        width: 100% !important;
                    ...
                    * {
                    ...
                    /* Fix for inputs to show values correctly and hide borders */
                    input, select {
                        border: none !important;
                        padding: 0 !important;
            ...
            `}</style>
            <section className="py-20 bg-linear-to-br from-slate-100 via-gray-50 to-slate-200">
                <div className="max-w-5xl mx-auto px-4">
                    ...
                    ══════════════════════════════════════════════ */}
                        <div className="w-full bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                            <div className="bg-linear-to-r from-primary to-[#225f56] text-white px-5 py-3">
                                    ...
                                    <tbody>
                                        {project.plots.map((plot, idx) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <td className={`border border-gray-200 px-3 py-1.5 text-center font-medium ${isSelected ? "text-primary" : "text-gray-700"}`}>
                                                        {isSelected && (
                                                            <span className="inline-block w-1.5 h-1.5 rounded-full bg-primary mr-1 mb-0.5" />
                                                        )}
                                                        {plot.plot_no}
                                                    </td>
                            ...
                            {/* Totals footer */}
                            <div className="bg-primary text-white text-xs px-4 py-2 font-semibold text-center">
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between px-4 py-4 border-b border-gray-200 bg-white">
                                    ...
                                    <div className="text-right min-w-30">
                                        ...
                                        <p className="font-semibold text-accent text-xs leading-tight">
                                            {project.subtitle}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="px-4 py-4">
                                            ...
                                            <tr>
                                                ...
                                                <td className={val}>
                                                    <select
                                                        ...
                                                        className="w-full bg-white border border-gray-300 rounded px-2 py-1 text-sm text-gray-700 cursor-pointer outline-none focus:ring-1 focus:ring-primary"
                                                    >
                                    ...
                                    <table className="w-full border-collapse mb-3">
                                        <thead>
                                            ...
                                            <tr>
                                                <td className="border border-gray-300 px-3 py-1.5 text-center text-sm font-bold text-primary">
                                    ...
                                    {/* Signatory */}
                                    <div className="border-t border-dashed border-gray-300 pt-6 print:pt-4 pb-4 print:pb-2 flex justify-between items-center px-10 print:px-6">
                                        <div className="flex flex-col items-center gap-1">
                                            <div className="relative w-28 h-28 print:w-20 print:h-20 flex items-center justify-center">
                                                <Image
                                                    src="/stamp-removebg-preview.png"
                                                    alt="Official Stamp"
                                                    fill
                                                    className="object-contain opacity-90"
                                                />
                                            </div>
                                            <span className="text-[10px] print:text-[8px] text-[#6a0dad] font-bold uppercase tracking-wider">
                                                Official Stamp
                                            </span>
                                        </div>
                                        <div className="text-right flex flex-col items-end">
                                            <div className="mt-16 print:mt-10 border-b border-gray-400 w-40 print:w-32 ml-auto" />
                                            <p className="text-xs print:text-[10px] font-bold text-gray-800 mt-2 print:mt-1">Authorized Signatory</p>
                                            <p className="text-[10px] print:text-[8px] text-gray-500 mt-1 italic">
                                                DIDPL Management Team
                                            </p>
                                        </div>
                                    </div>

                                    {/* Footer Banner */}
                                    <div className="relative rounded-xl overflow-hidden h-16 print:h-12 mt-3 print:mt-1">
                                        <Image
                                        ...
                                        />
                                        <div className="absolute inset-0 bg-linear-to-r from-primary/70 to-[#6a0dad]/70 flex items-center justify-center">
                                            <p className="text-white font-bold tracking-widest text-sm print:text-xs drop-shadow">
